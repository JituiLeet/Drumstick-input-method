...
public final class DrumstickKeyboardView extends View {
    ...
    private String rl(String s){if(Prefs.language(getContext()).equals("en")){if(s.equals("中/英"))return engineChinese()?"中/英":"英/中";if(s.equals("空格"))return "Space";if(s.equals("↵"))return "Enter";if(s.equals("⌫"))return "Backspace";if(s.equals("🌐"))return "🌐";if(s.equals("表情"))return "Emoji";}return s;}
